...
public class RegistroPrestadorPage extends BaseClass {
	...
	By btnEmail = By.xpath("//input[@id=\"mat-input-3\"]");
	...
	public RegistroPrestadorPage(MobileElement elemento) throws InterruptedException
	{
		this.elemento=elemento;
	}
	public void registroPrestador(String url) throws InterruptedException
	{
		driver.get(url);
		Thread.sleep(10000);
	}
